  ...
  return (
    <div className="min-h-screen maple-leaf-bg relative overflow-hidden">
      ...
      <section className="hero-gradient py-20 relative overflow-hidden z-10">
        ...
        >
          <Leaf className="absolute top-20 left-10 h-12 w-12 text-primary/40 floating-element" />
          ...
          <Leaf className="absolute bottom-40 right-10 h-16 w-16 text-accent/30 floating-element animate-morph" />
        </div>
      ...
      >
        ...
        >
          ...
          <Leaf className="absolute top-1/2 left-1/4 h-16 w-16 text-white/20 floating-element animate-morph" />
        </div>
